...
const ProfileCard = (props) => {
  ...
  return (
    <Stack direction="horizontal" gap={3} className="justify-content-between" >
        <Stack direction="vertical" gap={3} className="justify-content-center align-items-center summarySection" >
        ...
        <Stack direction="vertical" gap={3} className="justify-content-between summarySection">
            <Form noValidate onSubmit={updateDetails} validated={validated}>
